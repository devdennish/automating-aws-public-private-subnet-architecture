...
key_name="BashKeyPair"
key_file="BashKeyPair.pem"
LaunchTemplateName="TemplateForAutoScaling-BashScript"
auto_scaling_group_name="Bash-Auto-Scaling-Group"
Version=AutoScalingVersion1
target_group_name="Bash-Target-Group"
lb_name="Bash-Load-Balancer"
